...
from model.model_utils import rpn_loss
...
class RegionProposalNetwork(nn.Module):
    ...
    def compute_loss(self, objectness, pred_bbox_delta, gt_box, anchor):
        ...
        objectness_loss, box_loss = rpn_loss(idx, pos_idx, objectness, label, pred_bbox_delta, regression_target)
    ...
    def forward(self, feature, image_shape, target=None):
        ...
        if self.training:
            ...
            return proposal, dict(loss_objectness=objectness_loss, loss_rpn_box_reg=box_loss)
